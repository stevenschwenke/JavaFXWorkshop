...
public class E_5_BindingVisualization extends Application implements Initializable {
    ...
    @FXML
    private Circle c_3_to_4;
    @FXML
    private Circle c_4_to_3;
    @FXML
    private Circle c_4_to_1;
    @FXML
    private Circle c_1_to_4;

    private SimpleBooleanProperty t1BoundToT2, t2BoundToT1, t2BoundToT3, t3BoundToT2, t3BoundToT4, t4BoundToT3, t4BoundToT1, t1BoundToT4;
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        t1BoundToT2.addListener(observable -> {
            ...
            if (((SimpleBooleanProperty) observable).get()) {
                c_1_to_2.setFill(Color.DODGERBLUE);
            } else {
                c_1_to_2.setFill(Color.LIGHTGRAY);
            }
        });
        ...
        t2BoundToT1.addListener(observable -> {
            ...
            if (((SimpleBooleanProperty) observable).get()) {
                c_2_to_1.setFill(Color.DODGERBLUE);
            } else {
                c_2_to_1.setFill(Color.LIGHTGRAY);
            }
        });
        ...
        t2BoundToT3.addListener(observable -> {
            ...
            if (((SimpleBooleanProperty) observable).get()) {
                c_2_to_3.setFill(Color.DODGERBLUE);
            } else {
                c_2_to_3.setFill(Color.LIGHTGRAY);
            }
        });
        ...
        t3BoundToT2.addListener(observable -> {
            ...
            if (((SimpleBooleanProperty) observable).get()) {
                c_3_to_2.setFill(Color.DODGERBLUE);
            } else {
                c_3_to_2.setFill(Color.LIGHTGRAY);
            }
        });
    ...
    private void resetBindings() {
        ...
        t1.textProperty().unbindBidirectional(t4.textProperty());
        ...
        t2.textProperty().unbindBidirectional(t4.textProperty());
        ...
        t3.textProperty().unbindBidirectional(t4.textProperty());

        t4.textProperty().unbind();
        t4.textProperty().unbindBidirectional(t1.textProperty());
        t4.textProperty().unbindBidirectional(t2.textProperty());
        t4.textProperty().unbindBidirectional(t3.textProperty());
